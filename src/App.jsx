...
// Домашние тренировки) — см. FULL_BODY_PROGRAM/SPLIT_PROGRAM/WEIGHT_LOSS_PROGRAM/
// HOME_PROGRAM выше. Дубли между программами убраны; варианты, отличавшиеся только
// номером уровня резинки (интенсивность, не отдельное упражнение), объединены в одно.
const EXERCISES = [
  // Ноги
