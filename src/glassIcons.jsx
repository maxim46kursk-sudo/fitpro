...
const IC = {
  ...
  // Замок для закрытых тарифом разделов. Раньше там стоял эмодзи 🔒 — он
  // рисуется системным шрифтом и в тёмной теме выглядит инородно рядом с
  // остальными иконками. Нейтральный, как barcode: это статус, не герой.
  lock: { glow: 'rgba(235,235,245,.22)', svg: (<>
    <rect x="5.5" y="10.5" width="13" height="9.5" rx="2.2" fill="rgba(235,235,245,0.34)"/>
    <path d="M8.5 10.5V8a3.5 3.5 0 0 1 7 0v2.5" fill="none" stroke="rgba(235,235,245,0.34)" strokeWidth="1.8" strokeLinecap="round"/>
    <circle cx="12" cy="15" r="1.5" fill="#1c1c1e"/></>) },
