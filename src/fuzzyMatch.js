// Нечёткое сравнение названий упражнений — используется конструктором
// тренировок, чтобы предупредить клиента о возможном дубле при создании
// нового упражнения в его личном списке. Ничего не блокирует, только
// предупреждает (см. ConstructorView в App.jsx).
