...
export const PLANS = [
  { key:'start',  level:0, name:'СТАРТ',  price:0,    testPrice:0,  tagline:'Бесплатно',
    features:['Дневник тренировок','Рационы питания','Общий тоннаж','Аналитика питания за день и неделю','Первые 3 тренировки в каждой программе','Библиотека упражнений'] },
