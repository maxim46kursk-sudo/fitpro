...
describe('показатели считаются по всем попыткам', () => {
  ...
  it('лучший день — максимум по СУММЕ дня, а не по одной попытке', () => {
    // в первом дне два уровня по 1000, во втором один заход на 1500
    submitAttempt('pro', { score: 1000 }, 1)
    submitAttempt('novice', { score: 1000 }, 1)
    submitAttempt('pro', { score: 1500 }, 2)

    expect(readRoom(2).best).toEqual({ day: 1, total: 2000 })
  })
